    ...
    <Link to="/register" >
      ...
      >
        ...
        <motion.div
          ...
          className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center z-10"
      ...
      shadow-xl hover:shadow-2xl transition-all duration-300 cursor-pointer" >
        ...
        <motion.div
          className="bg-gradient-to-t from-brrown/40  fixed top-[90%] w-full left-1/2 -translate-x-1/2 -translate-y-1/2 text-center z-10 flex flex-col items-center justify-center gap-6"
